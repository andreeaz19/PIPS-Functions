#This function automatically generates a simple pasta recipe once it is 22:00. 
#It can be used after late night study sessions in the library when there's no
#brain power left to decide what food to make.
remind_me <- function(){
